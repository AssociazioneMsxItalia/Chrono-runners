...
const CutCmd g_IntroCutscene[] = {
    ...
    CUT_LOAD_LAYOUT(g_Screen5, 0, CUTSCENE_GFX_Y, 32, CUTSCENE_GFX_ROWS - 1),

    CUT_SPRITE_WALK(&g_DocWalkLeft, 29*8, 16*8, 20*8, 16*8, 1),
	...
	// Entra Chrono
    CUT_SPRITE_WALK(&g_PlayerWalkRight, 0*8, 16*8, 14*8, 16*8, 2),
	...
	CUT_TEXT_TYPE("THE EVIL DOCTOR CRAZY IS", 19),
	CUT_TEXT_TYPE("BUILDING A TIME MACHINE.", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),

    CUT_TEXT_TYPE("HE WANTS TO BRING BACK", 19),
	CUT_TEXT_TYPE("THE NAZI REGIME!", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),

	CUT_SPRITE_ANIM(&g_PlayerFreaked, 14*8, 16*8, 100),

	CUT_TEXT_TYPE("YOU HAVE ONE HOUR TO STEAL", 19),
	CUT_TEXT_TYPE("THE FOUR TACHYON SINGULARITIES", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),
	...
	CUT_TEXT_TYPE("OTHERWISE, DR. CRAZY WILL USE", 19),
	CUT_TEXT_TYPE("THEM TO TRAVEL BACK IN TIME!", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),
	...
	CUT_TEXT_TYPE("IN YOUR JOURNEY YOU WILL FIND", 19),
	CUT_TEXT_TYPE("THE TIME CRYSTALS.", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),
	...
	CUT_TEXT_TYPE("THEY ALLOW YOU TO REWIND TIME.", 19),
	CUT_TEXT_TYPE("USE THEM WISELY!", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),
	...
	CUT_TEXT_TYPE("BRING THE SINGULARITIES TO ME", 19),
	CUT_TEXT_TYPE("WE WILL SAVE THE WORLD! GO!!!", 21),
    CUT_TEXT("- PRESS SPACE KEY -", 23),
	CUT_WAIT_KEY(),
	CUT_CLEAR_TEXT(),

    // Chrono esce
    CUT_SPRITE_WALK(&g_PlayerWalkLeft, 14*8, 16*8, 0*8, 16*8, 2),
	CUT_SPRITE_HIDE(0),
	CUT_SPRITE_HIDE(1),
	...
	CUT_SPRITE_WALK(&g_DocWalkRight, 20*8, 16*8, 29*8, 16*8, 1),
